...
const styles = StyleSheet.create({
  ...
  statNumber: { fontSize: 24, fontWeight: "900", fontFamily: "Poppins" },
  statLabel: { fontSize: 12, fontWeight: "600", fontFamily: "Poppins" },
  section: { paddingHorizontal: 16, marginTop: 20 },
  sectionHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 12 },
  sectionTitle: { fontSize: 20, fontWeight: "800", marginBottom: 12, fontFamily: "Playfair Display" },
  ...
  primaryButtonText: { fontSize: 18, fontWeight: "800", color: "#FFFFFF", flex: 1, fontFamily: "Poppins" },
  attemptCard: {
    flexDirection: "row",
    alignItems: "center",
    padding: 14,
  ...
  attemptInfo: { flex: 1 },
  attemptTitle: { fontSize: 15, fontWeight: "700", fontFamily: "Poppins" },
  ...
  quizInfo: { flex: 1 },
  quizTitle: { fontSize: 15, fontWeight: "700", fontFamily: "Poppins" },
  ...
  emptyTitle: { fontSize: 24, fontWeight: "800", textAlign: "center", fontFamily: "Playfair Display" },
  emptyText: { fontSize: 15, textAlign: "center", lineHeight: 22, fontFamily: "Poppins" },
});
